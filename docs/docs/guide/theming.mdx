---
title: Theming
description: Customize the look and feel of your ReactPress site
---

# Theming

ReactPress provides a flexible theming system with built-in dark mode support and full customization capabilities.

## Default Theme

ReactPress comes with a beautiful default theme that works out of the box:
...
- [View Example Themes](https://github.com/sylphxltd/reactpress/tree/main/examples/themes)
