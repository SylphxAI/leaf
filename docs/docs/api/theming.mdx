---
title: Theming API
description: API reference for creating custom ReactPress themes
---

# Theming API

Complete API reference for creating and customizing ReactPress themes.

## Theme Structure

A ReactPress theme package structure:
...
Access ReactPress config:

```typescript
import { useOutletContext } from "react-router-dom";

function MyComponent() {
  const config = useOutletContext<ReactPressConfig>();
...
```json
{
  "name": "@myorg/reactpress-theme-custom",
  "version": "1.0.0",
  "main": "./dist/index.js",
...
- [Default Theme](https://github.com/sylphxltd/reactpress/tree/main/packages/theme-default)
- [Minimal Theme](https://github.com/sylphxltd/reactpress-theme-minimal)
- [Blog Theme](https://github.com/sylphxltd/reactpress-theme-blog)
