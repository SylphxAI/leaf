---
title: Search
description: Full-text search functionality in ReactPress
---

# Search

ReactPress includes a powerful, fast, and lightweight full-text search system built into every documentation site.
...
ReactPress generates a search index during the build process:
...
- `react` → finds "ReactPress", "React", "reactive"
...
```typescript
import { Search } from "@sylphx/reactpress-theme-default";
...
ReactPress search vs alternatives:

| Feature | ReactPress | Algolia | Typesense |
|---------|-----------|---------|-----------|
