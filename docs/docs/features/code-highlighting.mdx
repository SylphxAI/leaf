...
description: Syntax highlighting and code features in ReactPress
---

# Code Highlighting

ReactPress provides beautiful syntax highlighting for code blocks with advanced features like line highlighting, line numbers, and code groups.
...
ReactPress supports 100+ programming languages including:
...
ReactPress uses custom syntax themes optimized for readability:
