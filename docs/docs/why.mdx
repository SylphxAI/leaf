---
title: Why ReactPress?
order: 3
---

# Why ReactPress?

ReactPress brings the power of React to documentation sites while maintaining the simplicity and speed of VitePress.

## Comparison with VitePress

| Feature | ReactPress | VitePress | Winner |
|---------|-----------|-----------|--------|
| **Framework** | React 18 | Vue 3 | 🤝 Tie |
| **Runtime** | Bun | Node.js | ⚡ ReactPress |
| **Build Speed** | ~400ms | ~800ms | ⚡ ReactPress |
| **Bundle Size** | 237KB (73KB gzip) | ~250KB | ⚡ ReactPress |
...
ReactPress uses **Sylphx tools** for minimal bundle size:
...
ReactPress has instant HMR powered by Vite. Changes appear in milliseconds.
:::
...
## When to Use ReactPress

✅ **Use ReactPress if you:**
...
This documentation site is built with ReactPress! You're experiencing:
...
Migrating is straightforward since ReactPress maintains VitePress markdown syntax:

1. **Copy markdown files** - They work as-is!
2. **Update config** - Similar structure
3. **Adjust imports** - Change `vitepress` to `@sylphx/reactpress`
4. **Run build** - Done!
