...
const themes = [
	{
		id: "default",
		name: "Default",
		description: "Modern documentation theme with clean design",
		icon: "🎨",
	},
	{
		id: "blog",
		name: "Blog",
		description: "Article-focused theme with blog cards",
		icon: "📝",
	},
	{
		id: "business",
...
const previewContent = {
	...
	excerpt:
		"This is a preview of how different themes look with actual content. You can see the variations in typography, spacing, colors, and overall design aesthetic.",
	content: `
# Getting Started
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
					<div>
						...
						<p class="text-xs text-gray-500 dark:text-gray-500">
							Package: @sylphx/leaf-theme-{currentTheme().id}
						</p>
					</div>
