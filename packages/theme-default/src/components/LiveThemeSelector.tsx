...
export default function LiveThemeSelector(): JSX.Element {
	...
	return (
		<div
			class={`live-theme-selector ${isTransitioning() ? "transitioning" : ""}`}
		>
			{/* Theme Selector Bar */}
				...
				<div class="max-w-6xl mx-auto px-6">
					<div class="text-center mb-16">
						<h1
							...
							style={{
								"font-family":
									selectedTheme() === "blog" ? "Georgia, serif" : "inherit",
							}}
						>
							Leaf Theme Showcase
						</h1>
						...
						>
							Experience the power of instant theme switching. Click the buttons
							above to see how Leaf transforms with different themes - from
							modern and clean to professional and minimal.
						</p>
					</div>
					...
					<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
						...
						>
							<div
								...
								style={{
									"border-radius":
										selectedTheme() === "business" ? "0.25rem" : "0.5rem",
								}}
							>
								<svg
							...
							>
								Built with SolidJS and Vite for optimal performance and instant
								loading.
							</p>
						</div>
						...
						>
							...
							>
								Choose from multiple professionally designed themes that work
								perfectly.
							</p>
						</div>
						...
						>
							...
							>
								Simple configuration with powerful features for documentation
								sites.
							</p>
						</div>
					</div>
					...
					<div class="text-center">
						<div
							class="inline-flex items-center gap-4 px-6 py-3 rounded-lg bg-gray-50 dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700"
							style={{
								"border-radius":
									selectedTheme() === "minimal" ? "0" : "0.75rem",
							}}
						>
